...
function Footer () {
    return (
        <footer className="flex flex-col justify-center items-center pb-7">
            ...
            <p className="font-normal text-xs text-center">Jl. Jalan Cipinang Muara, Jatinegara,
            Jakarta Timur.</p>

            <img className="w-14 mt-8 mb-1 opacity-90" src={Logo} alt="" />
